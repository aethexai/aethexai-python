"""Client-side validation of required body fields.
...
def sync_client() -> AethexAI:
    return AethexAI(api_key="ak_test_dummy", base_url="https://api.aethexai.com")


@pytest.fixture
def async_client() -> AsyncAethexAI:
    return AsyncAethexAI(api_key="ak_test_dummy", base_url="https://api.aethexai.com")
