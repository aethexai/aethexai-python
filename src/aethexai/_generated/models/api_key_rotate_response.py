...
class APIKeyRotateResponse:
    ...
    null-out parts of their state.
        ...
        Attributes:
            ...
            old_key_expires_at (None | str | Unset):
    ...
    old_key_expires_at: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        old_key_expires_at: None | str | Unset
        if isinstance(self.old_key_expires_at, Unset):
            old_key_expires_at = UNSET
        else:
            old_key_expires_at = self.old_key_expires_at
        ...
        if old_key_expires_at is not UNSET:
            field_dict["old_key_expires_at"] = old_key_expires_at
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_old_key_expires_at(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        old_key_expires_at = _parse_old_key_expires_at(d.pop("old_key_expires_at", UNSET))
