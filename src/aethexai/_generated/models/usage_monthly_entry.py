...
T = TypeVar("T", bound="UsageMonthlyEntry")


@_attrs_define
class UsageMonthlyEntry:
    """
    Attributes:
        count (int):
        month (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usage_monthly_entry.additional_properties = d
        return usage_monthly_entry
