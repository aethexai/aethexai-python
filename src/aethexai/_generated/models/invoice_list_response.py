...
class InvoiceListResponse:
    """``GET /billing/invoices`` payload.

    Cursor pagination via Stripe's ``starting_after`` (the last invoice
    ...
    The response field is named ``next_cursor`` and must not be renamed:
