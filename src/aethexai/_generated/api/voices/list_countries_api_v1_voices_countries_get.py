...
def sync_detailed(
    *,
    ...
    Wire shape is a list of ``{\"code\": \"NG\", \"name\": \"Nigeria\"}`` objects
    ...
    Adding a new country is an ``ALTER TYPE voice_country ADD VALUE``
    migration plus an entry in
    :data:`aethex.models.voice.VOICE_COUNTRY_CODES` and
    :data:`aethex.models.voice.VOICE_COUNTRY_NAMES`; the response surface
