...
from ...models.usage_monthly_entry import UsageMonthlyEntry
...
) -> HTTPValidationError | list[UsageMonthlyEntry] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = UsageMonthlyEntry.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | list[UsageMonthlyEntry]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | list[UsageMonthlyEntry]
    """
