...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/dashboard/usage/daily",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    \"primary\" table for the date set; the disjoint shape lets us keep
    request-empty days that still had ledger activity (e.g. a manual
