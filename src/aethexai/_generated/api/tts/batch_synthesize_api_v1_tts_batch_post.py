...
def sync_detailed(
    *,
    ...
    """Batch Synthesize
     ...
     Batch synthesis - submit multiple texts and receive a ``batch_id`` for polling. Poll ``GET /tts/batch/{batch_id}`` for presigned download URLs once items complete. Only successfully synthesized items are billed.
